...
kotlin {
    ...
    sourceSets {
        commonTest {
            dependencies {
                // implementation(libs.test.framework.prototype.integrations.kotestAssertions) // Use this outside of this project
                implementation(projects.testFrameworkIntegrations.kotestAssertions)
            }
        }
    }
}
