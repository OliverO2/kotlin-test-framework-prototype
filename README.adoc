...
If you declare a subclass of `TestSession`, its `configuration` parameter will define the global configuration for the entire compilation module. This example extends the framework's default configuration:
...
* [ ] Add test element hierarchy diagram.
